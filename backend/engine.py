...
async def _bi_snapshot_tick() -> int:
    """Fase 44: snapshot metrik BI harian (percepatan dashboard periode besar).

    Dipisah sebagai fungsi kecil di sini supaya scheduler tidak mengimpor modul analitik saat
    modul ini dimuat (impor melingkar: analytics_engine -> metrics -> ads_report -> engine).
    """
